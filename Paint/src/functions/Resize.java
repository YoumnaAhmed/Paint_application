...
public class Resize {
    ...
    public static void resizeTri(Triangle t, int x, int y){
        ...
        if(Math.abs(t.getX1()-x) < Math.abs(t.getX2()-x) && Math.abs(t.getX1()-x) < Math.abs(t.getX3()-x)){
            t.setX1(x);
            t.setY1(y);
        }
        else if(Math.abs(t.getX2()-x) < Math.abs(t.getX1()-x) && Math.abs(t.getX2()-x) < Math.abs(t.getX3()-x)){
            t.setX2(x);
            t.setY2(y);
        }
        else if(Math.abs(t.getX3()-x) < Math.abs(t.getX1()-x) && Math.abs(t.getX3()-x) < Math.abs(t.getX2()-x)){
            t.setX3(x);
            t.setY3(y);
        }
    }
